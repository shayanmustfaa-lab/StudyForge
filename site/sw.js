...
self.addEventListener('fetch',e=>{
  ...
  const fresh=u.pathname.includes('/study-center')||u.pathname.includes('/marks-predictor-standalone')||u.pathname.includes('/book-solutions')||u.pathname.endsWith('/sw.js');
  if(fresh){
