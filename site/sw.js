...
self.addEventListener('fetch',e=>{
  ...
  const fresh=isShell||u.pathname.includes('/study-center')||u.pathname.includes('/marks-predictor-standalone')||u.pathname.includes('/book-solutions')||u.pathname.includes('/overview-day8')||u.pathname.endsWith('/sw.js');
  if(fresh){
